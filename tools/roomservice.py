...
def get_from_manifest(devicename):
    try:
        lm = ElementTree.parse(".repo/local_manifests/cm.xml")
        lm = lm.getroot()
    except:
...
def add_to_manifest(repositories, fallback_branch = None):
    ...
    f = open('.repo/local_manifests/cm.xml', 'w')
    f.write(raw_xml)
    f.close()
...
print "Repository for %s not found in the CyanogenMod Github repository list. If this is in error, you may need to manually add it to your local_manifests/cm.xml." % device
