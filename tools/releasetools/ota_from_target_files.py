...
def WriteBlockIncrementalOTAPackage(target_zip, source_zip, output_zip):
  ...
  source_fp = GetIncrementalVersion(OPTIONS.source_info_dict)
  target_fp = GetIncrementalVersion(OPTIONS.target_info_dict)
...
""" % bcb_dev)
  ...
  if oem_props is None:
      script.AssertSomeIncrementalVersion(source_fp)
  else:
