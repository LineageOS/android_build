...
class EdifyGenerator(object):
  ...
  def AssertSomeIncrementalVersion(self, *fp):
    ...
    cmd = (' ||\n    '.join([('file_getprop("/system/build.prop", "ro.build.version.incremental") == "%s"') % i
                             for i in fp]) +
           ' ||\n    abort("E%d: Package expects build incremental of %s; '
           'this device has " + file_getprop("/system/build.prop", "ro.build.version.incremental") + ".");') % (
