...
def BuildImage(in_dir, prop_dict, out_file,
  ...
  if fs_type.startswith("ext"):
    ...
    if "transparent_compression_extensions" in prop_dict:
      build_command.extend(["-Z", prop_dict["transparent_compression_extensions"]])
...
def ImagePropFromGlobalDict(glob_dict, mount_point):
  ...
  common_props = (
      ...
      "transparent_compression_extensions"
      )
