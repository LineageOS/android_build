...
if __name__ == '__main__':
    ...
    def sort_changes(review_a, review_b):
        current_a = review_a['current_revision']
        parents_a = [i['commit'] for i in review_a['revisions'][current_a]['commit']['parents']]
        current_b = review_b['current_revision']
        parents_b = [i['commit'] for i in review_b['revisions'][current_b]['commit']['parents']]
    ...
    if args.topic:
        ...
        change_numbers = [str(i['number']) for i in sorted(reviews, key=cmp_to_key(sort_changes))]
    if args.query:
