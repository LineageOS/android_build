...
# based on the linux kernel's cc-option
mcpu-arg = $(shell set -e;		\
	TMP="/tmp/cyanogenmod_mcpu_test.$$$$.tmp";	\
	if ($(ARM_EABI_TOOLCHAIN)/arm-eabi-gcc -mcpu=$(1) -c -xc /dev/null -o "$$TMP") >/dev/null 2>&1;	\
	then echo "$(1)";		\
	else echo "$(2)";		\
	fi;				\
	rm -f "$$TMP")
