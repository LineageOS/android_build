...
# Check if proper correct header_version is set
...
ifneq ($(or $(BOARD_INCLUDE_RECOVERY_DTBO),$(BOARD_INCLUDE_RECOVERY_ACPIO)),)
  ifneq ($(filter 1 2,$(BOARD_BOOTIMG_HEADER_VERSION)),)
    $(error header_version must be 1 or higher order to use BOARD_INCLUDE_RECOVERY_DTBO/ACPIO)
  endif
endif
