...
ifeq ($(CURRENT_CLEAN_BUILD_VERSION),MISSING)
  ...
  $(foreach step,$(steps), \
    ...
    $(call -cs-rewrite-cleanstep,$(INTERNAL_CLEAN_STEP.$(step)),$($(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES),$(TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES))\
    )
  endif
  _crs_new_cmd :=
  steps :=
