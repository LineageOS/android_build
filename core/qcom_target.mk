...
$(call project-set-path,qcom-$(2),$(strip $(if $(QCOM_HARDWARE_VARIANT_$(1)), \
    hardware/qcom/$(2)-caf/$(QCOM_HARDWARE_VARIANT_$(1)), \
    hardware/qcom/$(2)-caf/$(QCOM_HARDWARE_VARIANT))))
endef
...
$(call set-platform-specific-path,AUDIO,audio)
$(call set-platform-specific-path,DISPLAY,display)
$(call set-platform-specific-path,MEDIA,media)
