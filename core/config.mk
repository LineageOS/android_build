...
ifdef TARGET_BUILD_WITH_APPS_VERSION_CODE
APPS_DEFAULT_VERSION_CODE := $(call int_plus,$(PLATFORM_SDK_VERSION),$(BUILD_DATETIME_FROM_FILE))
else
APPS_DEFAULT_VERSION_CODE := $(PLATFORM_SDK_VERSION)
endif
