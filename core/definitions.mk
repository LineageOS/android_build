...
define publish-to-maven
	$(hide) mvn install:install-file -Dfile=$(@) -DgroupId=$(PRIVATE_MAVEN_GROUPID) -DartifactId=$(PRIVATE_MAVEN_ARTIFACT) -Dversion=$(PRIVATE_MAVEN_VERSION) -Dpackaging=$(PRIVATE_MAVEN_PACKAGING)
	$(if $(GLOBAL_MAVEN_REPOSITORY),$(hide) mvn deploy:deploy-file -Dfile=$(@) -DrepositoryId=$(GLOBAL_MAVEN_REPOSITORY) -Durl=$(GLOBAL_MAVEN_URL) -DgroupId=$(PRIVATE_MAVEN_GROUPID) -DartifactId=$(PRIVATE_MAVEN_ARTIFACT) -Dversion=$(PRIVATE_MAVEN_VERSION) -Dpackaging=$(PRIVATE_MAVEN_PACKAGING))
endef
