...
ifeq ($(TARGET_ARCH),arm)
    ...
    ifeq ($(HOST_OS),darwin)
      ...
      ifneq ($(TARGET_KERNEL_USE_CUSTOM_TOOLCHAIN),)
        ARM_CROSS_COMPILE:=CROSS_COMPILE="$(ccache) $(ANDROID_BUILD_TOP)/prebuilt/linux-x86/toolchain/$(TARGET_KERNEL_USE_CUSTOM_TOOLCHAIN)/bin/arm-eabi-"
      else
