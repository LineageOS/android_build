...
KERNEL_SRC ?= kernel/$(TARGET_BOOTLOADER_BOARD_NAME)
...
ifeq "$(wildcard $(KERNEL_SRC) )" ""
    ifneq ($(TARGET_PREBUILT_KERNEL),)
        ...
        $(warning * and define the KERNEL_DEFCONFIG variable in AndroidBoard.mk *)
        $(warning *                                                             *)
    ...
    ifeq ($(KERNEL_DEFCONFIG),)
        ...
        $(warning * Please add the KERNEL_DEFCONFIG variable to your       *)
