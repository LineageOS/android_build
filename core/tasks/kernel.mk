...
KERNEL_ADDITIONAL_CONFIG_TYPE_OUT := $(KERNEL_OUT)/.additional_config

.PHONY: force_defconfig
$(KERNEL_ADDITIONAL_CONFIG_TYPE_OUT): force_defconfig
	$(hide) cat $(KERNEL_ADDITIONAL_CONFIG_SRC) < /dev/null | cmp -s - $@ || cat $(KERNEL_ADDITIONAL_CONFIG_SRC) < /dev/null > $@

$(KERNEL_CONFIG): $(KERNEL_OUT_STAMP) $(KERNEL_DEFCONFIG_SRC) $(KERNEL_ADDITIONAL_CONFIG_TYPE_OUT)
